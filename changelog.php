...
- Liste des équipements : Des cases à cocher sont disponibles permettant de réaliser des operations multiples. (./asset_list.php)<br />
- Connexion : Amélioration de la vitesse de vérification des identifiants et mot de passe (./login.php)<br />
- Paramètres : L'ensemble des fuseaux horaire sont disponibles (./admin/parameters.php)<br />
...
- Ticket : Sur certaines images dans la résolution ou dans la description la scrollbar horizontal n'apparaissait pas (./ticket.php)<br />
...
- Ticket : Sur certains champs obligatoire, le bouton Annuler ne fonctionnait pas dans certains cas (./ticket.php)<br />
...
- Mail : Le mail à destination du demandeur n'est pas envoyé si la résolution est marqué comme privé (./core/auto_mail.php)<br />
...
- Procédure : Erreur de d'initialisation de variables lors de la suppression d'une catégorie ou sous catégorie (./admin/list.php)<br />
...
- Statistiques : Erreur de comptage de certains ticket sur l'évolution des tickets ouverts et fermés avec le filtre tous les mois et toutes les années. (./stat/line_tickets.php)<br />
