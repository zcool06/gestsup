							...
							<tr class="bgc-h-orange-l4" >	
								...
								<td>
									<div class="hidden-phone visible-desktop btn-group">	
										...
										if($rright['procedure_modify']) {echo'<a class="btn action-btn btn-xs btn-warning mr-1" href="./index.php?page=procedure&amp;id='.$procedure['id'].'&amp;action=edit" title="'.T_('Modifier cette procédure').'" ><center><span style="color:#FFF;#"><i class="fa fa-pencil-alt"></i></span></center></a>';}
										if($rright['procedure_delete']) {echo'<a class="btn action-btn btn-xs btn-danger" onClick="javascript: return confirm(\''.T_('Êtes-vous sur de vouloir supprimer cette procédure ?').'\');" href="./index.php?page=procedure&amp;id='.$procedure['id'].'&amp;action=delete" title="'.T_('Supprimer cette procédure').'" ><center><i class="fa fa-trash"></i></center></a>';}
										echo '
									</div>
								</td>
							</tr>
