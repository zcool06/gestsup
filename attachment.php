...
if($globalrow['state']!=3 && $rright['ticket_attachment'])
{
	...
	if(!$hide_attachment)
	{
		...
		<button class="btn btn-sm btn-success" title="'.T_('Enregistrer le ticket et charger le fichier').'" onclick="check_size();" name="upload" value="upload" type="submit" id="upload"><i class="fa fa-upload"></i></button>
		';
	}
