	...
	<div class="table-responsive">
		<div class="col-xs-12">
			<table id="simple-table" class="table table-bordered table-bordered table-striped table-hover text-dark-m2"> 
				...
				warranty_time=$_GET[warranty_time]&amp;
...
<div class="row">
	...
	if($rright['task_checkbox'] && $resultcount[0]>0)
	{
		echo '
			...
			<select style="width:auto" class="form-control form-control-sm mt-4" title="'.T_('Effectue des actions pour les équipements sélectionnés').'." name="selectrow" onchange="if(confirm(\''.T_('Êtes-vous sûr de réaliser cette opération sur les équipements sélectionnés').'?\')) this.form.submit();">
