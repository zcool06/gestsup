			...
			<tbody>
				<tr>
					...
					<td class="text-95 text-default-d3">
						<img src="./images/<?php echo strtolower($os); ?>_ok.png" style="border-style: none; margin-right:2px;" alt="img" /> <?php echo "<b>OS :</b> {$phpinfo['phpinfo']['System']}<br />"; ?>
						<?php 
							echo '<img src="./images/'.$web_server_icon.'" style="border-style: none; margin-right:2px;" alt="img" /> <b>'.ucfirst($web_server_name).' :</b> '.$web_server_version.' <i>('.$_SERVER['SERVER_PROTOCOL'].')</i><br />';
						?>
				...
				<tr>
					...
					<td class="text-95 text-default-d3">
						...
						echo "<br />";
						if(extension_loaded('ftp')) echo '<i class="fa fa-check-circle text-success"></i> <b>php_ftp :</b> '.T_('Activée'); else echo '<i class="fa fa-times-circle text-danger"></i> <b>php_ftp</b> : '.T_("Désactivée").' <i>('.T_("Seule la mise à jour manuelle sera possible, dé-commenter la ligne extension=php_ftp votre php.ini'").')</i>';
						echo "<br />";
						...
						echo "<br />";
						if(extension_loaded('fileinfo')) echo '<i class="fa fa-check-circle text-success"></i> <b>php_fileinfo :</b> '.T_('Activée'); else echo '<i class="fa fa-times-circle text-danger"></i> <b>php_fileinfo</b> : '.T_("Désactivée").' <i>('.T_("Le connecteur IMAP ne fonctionnera pas. apt install php7.3-fileinfo").')</i>';
						echo "<br />";
						if(extension_loaded('iconv')) echo '<i class="fa fa-check-circle text-success"></i> <b>php_iconv :</b> '.T_('Activée'); else echo '<i class="fa fa-times-circle text-danger"></i> <b>php_iconv</b> : '.T_("Désactivée").' <i>('.T_("Le connecteur IMAP ne fonctionnera pas. apt install php7.3-iconv").')</i>';
						?>
					</td>
				</tr>
				<tr>
