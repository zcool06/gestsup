						...
						<tr class="bgc-white text-secondary-d3 text-95">
							...
							<?php
								...
								if(($_SESSION['profile_id']==0 || $_SESSION['profile_id']==3 || $_SESSION['profile_id']==4) || ($rright['side_all'] && ($_GET['userid']=='%'|| $keywords!='')) || ($rparameters['user_company_view']!=0 && $_GET['userid']=='%' && ($rright['side_company'] || $keywords!=''))) 
								{
									echo '
									<td align="center" >
										<select class="chosen-select" data-placeholder=" " style="width:100% !important;" name="user" onchange="submit()">
											<option value="%"></option>
											<option value="0">'.T_('Aucun').'</option>';
											//display users list
											if($join)
						...
						{ 
							...
							echo '
								<tr class="bgc-h-default-l3 d-style">
									...
									if(($_SESSION['profile_id']==0 || $_SESSION['profile_id']==3 || $_SESSION['profile_id']==4) || ($rright['side_all'] && ($_GET['userid']=='%'|| $keywords!='')) || ($rparameters['user_company_view']!=0 && $_GET['userid']=='%' && ($rright['side_company'] || $keywords!=''))) 
									{
										echo '<td onclick="document.location=\' '.$open_ticket_link.' \'"><center><a class="td" title="'.$resultuser['firstname'].' '.$resultuser['lastname'].' '.$resultuser['phone'].'" href="'.$open_ticket_link.'">'.T_(" $displayusername").'</a></center></td>';
									}
